...
# Set working directory to the files loca
getwd()
...
#Save model --> for ease in future rather than constantly rerunning model
save(SE_RT_single_int4, file='SE_RT_single_int4.Rda')
```
...
#Save model --> for ease in future rather than constantly rerunning model
save(SE_RT_single_age_int4, file='SE_RT_single_age_int4.Rda')
```
...
SE_single_SF_RTs_emm.df <- SE_single_RTs_emm.df %>% 
  filter(Association == "self" | Association == "friend")
...
SE_single_HN_RTs_emm.df <- SE_single_RTs_emm.df %>% 
  filter(Association == "happy"| Association =="neutral")
...
#Save model --> for ease in future rather than constantly rerunning model
save(SE_ACC_single_int2, file='SE_ACC_single_int2.Rda')
```
...
# Save model --> for ease in future rather than constantly rerunning model
 save(SR_RT_single_int4, file='SR_RT_single_int4.Rda')
```
